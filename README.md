...
A production-ready pipeline for forecasting multiple time series on **Microsoft Fabric**.If you need to run a local demo without Fabric, please refer to README for DEMO.md
